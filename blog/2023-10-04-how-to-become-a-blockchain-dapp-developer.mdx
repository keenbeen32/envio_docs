...
description: "Learn how to become a blockchain dApp developer with this comprehensive guide covering key concepts, technologies, and tools including Envio."
---

<img src="/static/images/blog-assets/envio-how-to-become-a-blockchain-dapp-developer.png" alt="Cover Image How to Become a Blockchain DApp Developer" width="100%"/>
...
Before diving into blockchain development, it's essential to know the lingo. There are plenty of different programming languages readily available, but let's explore some commonly used in blockchain development: [Solidity](https://soliditylang.org/), [JavaScript](/HyperIndex/Advanced/terminology#javascript), [ReScript](/HyperIndex/Advanced/terminology#rescript), and [Rust](https://www.rust-lang.org/). We'll dive into their unique characteristics and how they fit into the blockchain development landscape and developer experience.
...
Envio is your gateway to frictionless and rapid blockchain development. Say goodbye to the challenges of latency, reliability, and costs that often plague developers. By leveraging Envio, you'll have the [tools](/Blog/2023-08-17-what-is-an-indexer) you need to access, transform, and store real-time or historical data from any EVM-compatible smart contract.
