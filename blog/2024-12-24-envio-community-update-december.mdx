...
description: "December 2024 developer update covering version 2.11.0 release, HyperSync milestone, Blocksquare integration, and holiday greetings from the Envio team."
---

<img src="/static/images/blog-assets/envio-developer-community-december-2024.png" alt="Cover Image Envio Developer Community Update December 2024" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-december-2024-1.png" alt="HyperSync Milestone #2" width="100%"/>

With nearly 80 billion requests served, [HyperSync](/HyperSync/overview) is rapidly becoming a top choice as a data source for faster data retrieval than standard RPC. Envio's indexer, HyperIndex, supports both RPC and HyperSync as sources for ingesting blockchain data.

The traditional method of retrieving blockchain data relies on RPC, which, although functional, becomes inefficient when querying large amounts of data. Hypersync enables data access up to 2000x faster than a standard node and also provides this data free of charge.
...
<img src="/static/images/blog-assets/envio-developer-community-december-2024-2.png" alt="Blocksqaure Integration" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-december-2024-3.png" alt="Indexing & Reorgs" width="100%"/>
...
Explore the full [blog](/blog/2024-11-26-indexing-and-reorgs).

## Tokenizing RWAs: How Blockchain is Redefining Real Estate Investment

<img src="/static/images/blog-assets/envio-developer-community-december-2024-4.png" alt="Tokenizing RWAs" width="100%"/>
...
Read the [full case study](/blog/2024-12-09-tokenizing-real-world-assets).

## Dev Tutorial: Indexing Data on Rootstock

<img src="/static/images/blog-assets/envio-developer-community-december-2024-5.png" alt="Indexing Data on Rootstock" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-december-2024-6.png" alt="Redefining Privacy with ZKPs" width="100%"/>
...
Read the full [blog](/blog/2024-12-18-case-study-zkpass).

## Envio Powers BakoID's Handles with Efficient Data Indexing

<img src="/static/images/blog-assets/envio-developer-community-december-2024-7.png" alt="Envio Powers Bako" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-december-2024-8.png" alt="December Featured Dev" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-december-2024-9.png" alt="December Playlist" width="100%"/>
