...
description: "Fourth monthly community update covering HyperSync network updates, technical developments, and exciting milestones from the Envio team."
---

<img src="/static/images/blog-assets/envio-developer-community-update-4.png" alt="Cover Image Envio Developer Community Update No.4" width="100%"/>
...
Read more details [here](/Blog/2023-11-23-envio-bounty-poap-multi-chain-indexer).
...
We will continue to run the Envio "[Build Bigger. Ship faster](/Blog/2023-08-22-envio-grant-program-is-live)" grant program with a few interesting use cases but feel free to apply your unique ideas by simply reaching out to the team in our Discord.
