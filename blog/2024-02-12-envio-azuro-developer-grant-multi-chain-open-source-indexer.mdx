...
description: "Announcing a collaboration grant opportunity to build an open-source multi-chain indexer for the Azuro Protocol using Envio SDK for $1500 USDC."
---

<img src="/static/images/blog-assets/envio-azuro-developer-grant.png" alt="Azuro Envio Developer Grant Cover Image" width="100%"/>
...
- Envio Installation: [/HyperIndex/Introduction/getting-started](/HyperIndex/Introduction/getting-started)
- Envio Multi-chain indexing: [/HyperIndex/Advanced/multichain-indexing](/HyperIndex/Advanced/multichain-indexing)
- Envio Factory Contracts: [/HyperIndex/Advanced/dynamic-contracts](/HyperIndex/Advanced/dynamic-contracts)
- Envio's Hosted Service: [/HyperIndex/Hosted_Service/hosted-service](/HyperIndex/Hosted_Service/hosted-service)
