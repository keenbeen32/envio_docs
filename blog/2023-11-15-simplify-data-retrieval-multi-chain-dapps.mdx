...
description: "Learn how Envio's multi-chain indexing feature simplifies data retrieval across multiple blockchain networks for Web3 applications."
---

<img src="/static/images/blog-assets/envio-simplifies-data-retrieval-for-multi-chain-dapps.png" alt="Cover Image for Simplifying Data Retrieval for Multi-chain dApps" width="100%"/>
...
To witness the power of this advancement in action, let's explore a practical example using Envio's [Greeter Contract Tutorial](/HyperIndex/Tutorials/greeter-tutorial) further below.
...
For a more comprehensive walkthrough on this feature, the documentation can be found [here](/HyperIndex/Advanced/multichain-indexing).

For a more complicated multi-chain indexing example, builders are encouraged to explore the [Compound V2 Liquidation Metrics](/HyperIndex/Examples/example-velodrome-aerodrome) indexer, built by Envio's first successful Grantee as part of the [Envio "Build Bigger. Ship Faster" Program](/blog/2023-08-22-envio-grant-program-is-live).
