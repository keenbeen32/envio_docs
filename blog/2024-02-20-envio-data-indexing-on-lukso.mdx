...
description: "Envio's HyperIndex now fully supports developers building on LUKSO with hyper-performant query speeds for efficient on-chain data organization."
---

<img src="/static/images/blog-assets/envio-partner-lukso.png" alt="Envio Lukso Partnership Cover Image" width="100%"/>
...
- HyperSync: To ensure blazing-fast retrieval of historical on-chain data and a seamless developer experience, Envio's HyperSync endpoint allows for 2000x faster indexing than standard RPC.
