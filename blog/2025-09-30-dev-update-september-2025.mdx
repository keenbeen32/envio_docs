...
description: "September 2025 developer update covering v2.28.0 & v2.29.0 with Block Handlers, _meta query, performance improvements, and hackathon updates."
---

<img src="/static/images/blog-assets/sep-update-2025-0.png" alt="Cover Image Envio Developer Community Update September 2025" width="100%"/>
...
We've refactored internal tables to focus on a single public entry point: `_meta`. Internal tables such as `chain_metadata`, `event_sync_state`, `persisted_state`, `end_of_block_range_scanned_data`, and **`dynamic_contract_registry`** are now hidden from Hasura, and their internal representations have changed.

If this impacts your setup, reach out, and we'll help you migrate smoothly.

<img src="/static/images/blog-assets/sep-update-2025-1.png" alt="query" width="100%"/>
...
Read our [docs](/HyperIndex/block-handlers) to learn more about block handlers and the powerful use cases they enable, like:
...
<img src="/static/images/blog-assets/sep-update-2025-2.png" alt="liqo" width="100%"/>
...
<img src="/static/images/blog-assets/sep-update-2025-3.png" alt="metamask hackathon" width="100%"/>
...
<img src="/static/images/blog-assets/sep-update-2025-4.png" alt="ethglobal new dehli" width="100%"/>
...
<img src="/static/images/blog-assets/sep-update-2025-5.png" alt="megaeth support" width="100%"/>
...
<img src="/static/images/blog-assets/sep-update-2025-6.png" alt="neonevm ama" width="100%"/>
...
<img src="/static/images/blog-assets/sep-update-2025-7.png" alt="encode london 2025" width="100%"/>
...
More workshops are on the way, so be sure to subscribe this YouTube [channel](https://www.youtube.com/@decryptedbytes/playlists) to follow along and catch every session.
...
<img src="/static/images/blog-assets/sep-update-2025-8.png" alt="DOTM Sep 2025" width="100%"/>
...
<img src="/static/images/blog-assets/sep-update-2025-9.png" alt="PLOTM Sep 2025" width="100%"/>
