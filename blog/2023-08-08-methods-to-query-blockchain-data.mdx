...
description: "Explore different methods to query blockchain data and understand their trade-offs, from hosting your own node to using indexing solutions."
---

<img src="/static/images/blog-assets/envio-existing-methods-query-blockchain-data.png" alt="future of blockchain indexing" width="100%"/>
