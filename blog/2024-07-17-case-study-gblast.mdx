...
description: "Learn how GBlast integrated Envio's high-performance blockchain data indexing to power its GambleFi platform with real-time data synchronization."
---

<img src="/static/images/blog-assets/case-study-gblast.png" alt="Cover Image for Case Study GBlast" width="100%"/>
...
By leveraging [HyperSync](/HyperSync/overview) for data ingestion instead of JSON-RPC, GBlast has drastically improved its syncing performance and future-proofed their application, so that even the largest datasets only take a few minutes to index.
...
For more information on how to deploy an indexer to Envio's hosted service visit our [developer docs](/HyperIndex/Hosted_Service/hosted-service).
