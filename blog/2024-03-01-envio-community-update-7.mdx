...
description: "Seventh community update covering Azuro developer grant, HyperSync network updates, bootcamps, and technical developments from the Envio team."
---

<img src="/static/images/blog-assets/envio-developer-community-update-7.jpg" alt="Cover Image Envio Developer Community Update No.7" width="100%"/>
...
Notable activities include a double dose of version updates that aim to supercharge your development experience. The team noticed a small regression affecting the [contract import](/HyperIndex/Introduction/contract-import) templates, prompting us to roll out two brand-spanking new versions with some exciting additions that can be seen in the technical overview below.
...
Learn more about the grant opportunity [here](/blog/2024-02-12-envio-azuro-developer-grant-multi-chain-open-source-indexer).

## New HyperSync Network Support ⚡

We're very thrilled to announce that Envio [HyperSync](/HyperSync/overview) has added even more significant updates to existing networks and added new and enhanced indexing support for developers building on [Arbitrum](https://arbitrum.io/) Sepolia, [Zeta](https://www.zetachain.com/), [RSK](https://rootstock.io/) (Rootstock), [Berachain](https://www.berachain.com/) Artio (testnet), [Shimmer](https://shimmer.network/) and [NeonEVM](https://neonevm.org/) with many more to come!

To see a full list of currently supported chains on HyperSync visit our [docs](/HyperSync/hypersync-supported-networks).
...
- [Indexing OP Bridge Deposits](/HyperIndex/Tutorials/tutorial-op-bridge-deposits) on [Optimism](https://www.optimism.io/) & [Ethereum](https://ethereum.org/) Mainnet (Includes [video tutorial](https://www.youtube.com/watch?v=9U2MTFU9or0))
- [Indexing ERC20 Token Transfers](/HyperIndex/Tutorials/tutorial-erc20-token-transfers) on [Base](https://www.base.org/) (Includes [video tutorial](https://www.youtube.com/watch?v=e1xznmKBLa8))
...
- console.log and friends (console.warn, console.error etc) are now powered by [Pino](https://getpino.io/#/), making your logs more accessible and informative in the [hosted service](/HyperIndex/Hosted_Service/hosted-service).
...
2. **Referencing Other Entities in Your Schema**
