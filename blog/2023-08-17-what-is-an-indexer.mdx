...
description: "Learn how blockchain indexers work, their core components, and how they improve the developer experience for Web3 applications."
---

<img src="/static/images/blog-assets/envio-what-is-an-indexer.png" alt="Envio Cover Photo" width="100%"/>
...
Here's an example of a config.yaml file for indexing a live [Greeter smart contract example](/HyperIndex/Tutorials/greeter-tutorial) deployed on Polygon.
...
<img src="/static/images/blog-assets/envio-conceptual-architecture-1.png" alt="Envio Indexer Conceptual Diagram" width="100%"/>
