...
description: "Eighth community update covering HyperSync network updates, new hosted service features, technical developments, and milestones from the Envio team."
---

<img src="/static/images/blog-assets/envio-developer-community-update-8.png" alt="Cover Image Envio Developer Community Update No.8" width="100%"/>
...
Excited to announce that Envio [HyperSync](/HyperSync/overview) has added enhanced indexing and contract import support for developers building on [Blast](https://blast.io/en) Mainnet and Blast Sepolia ⚡

To see the full list of currently supported chains on HyperSync visit our [docs](/HyperSync/hypersync-supported-networks). Please note, that this list is for HyperSync-supported networks only. Envio's HyperIndex, as the indexing framework, supports any EVM network using RPC. If you would like HyperSync added to a network we don't support, just let us know!

In addition, we're very excited to announce that Envio's HyperSync now provides full support for developers building across ANY Polygon network with our accelerated data query layer providing APIs that bypass traditional RPC for 2000x faster syncing of historical data.
...
<img src="/static/images/blog-assets/envio-new-feature-multiple-indexers.png" alt="Screenshot of hosted service" width="60%"/>

<img src="/static/images/blog-assets/envio-new-feature-multiple-indexer-2.png" alt="Screenshot of hosted service" width="60%"/>
...
<img src="/static/images/blog-assets/envio-tui.gif" alt="Envio's new CLI look and sync progress bars" width="50%"/>
...
For further information, refer to our [documentation](/HyperIndex/Advanced/linked-entity-loaders).
