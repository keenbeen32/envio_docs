...
description: "September 2024 developer update covering version 2.3.0 release with Wildcard Indexing and IPFS integration, EthOnline hackathon winners, and Token2049/EthCapeTown highlights."
---

<img src="/static/images/blog-assets/envio-developer-community-sep-2024.png" alt="Cover Image Envio Developer Community Update September 2024" width="100%"/>

Welcome to our September 2024 developer update!

We're back with another exciting update on the latest and greatest advancements from the Envio team. In this update, we'll explore our recent release, V2.3.0, highlighting innovative features like [Wildcard Indexing](/HyperIndex/Advanced/wildcard-indexing), [IPFS](/HyperIndex/Advanced/ipfs) integration, and more. We'll also recap key updates from September, including our time at [Token2049](https://www.asia.token2049.com/) and [EthCapeTown](https://www.ethcapetown.com/), upcoming events, partnerships, and other important developments.
...
Learn more [here](/HyperIndex/Advanced/wildcard-indexing).
...
Learn more [here](/HyperIndex/Advanced/ipfs).

## EthGlobal Online Hackathon Winners

<img src="/static/images/blog-assets/envio-developer-community-sep-2024-2.png" alt="Cover Image ETHGlobal Online Hackathon Winners" width="100%"/>
...
With [Hypersync](/HyperSync/overview) integrated, applications and data analysts can now fetch their data using standard RPC, or leverage HyperSync as more performant data source for up to a 2000x speed advantage. Apps can now develop, test, and innovate faster than before and deliver cutting-edge performance to their end users.

<img src="/static/images/blog-assets/envio-developer-community-sep-2024-3.png" alt="Cover Image Envio and Zircuit Partnership Announcement" width="100%"/>
...
Hypersync supported networks can be viewed [here](/HyperSync/hypersync-supported-networks).
...
<img src="/static/images/blog-assets/envio-developer-community-sep-2024-4.png" alt="Cover Image Encode Club Indexing On Fuel" width="100%"/>

- [How to Index Dat on Citrea in < 5mins](https://www.youtube.com/watch?v=rPPxS6ORaEc)

<img src="/static/images/blog-assets/envio-developer-community-sep-2024-5.png" alt="Cover Image Indexing On Citrea" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-sep-2024-6.png" alt="Dev of the Month September" width="100%"/>
...
<img src="/static/images/blog-assets/envio-developer-community-sep-2024-7.png" alt="Picture of Envio Branded Caps" width="100%"/>

## Playlist of the Month 🎧️

▶️ [Open Spotify](https://open.spotify.com/playlist/74X6dI8SMqdrjSl1ECKF5e?si=2d979afa6d6a46ac)

<img src="/static/images/blog-assets/envio-developer-community-sep-2024-8.png" alt="Envio Spotify Playlist of the Month" width="100%"/>
