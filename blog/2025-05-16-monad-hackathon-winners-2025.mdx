...
description: "Celebrating the winners of the first-ever Monad hackathon (evm/accathon) who built outstanding projects using Envio's indexing infrastructure."
---

<img src="/static/images/blog-assets/monad-hackathon-winners-2025.png" alt="Cover Image Monad Hackathon Winners" width="100%"/>
...
→ [Start indexing Monad data](/HyperIndex/overview)
