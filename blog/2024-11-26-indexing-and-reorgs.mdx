...
description: "Understanding chain reorganizations and their implications on blockchain indexing, including considerations for multichain environments and how to design for reorgs."
---

<img src="/static/images/blog-assets/indexing-and-reorgs.png" alt="Envio Cover Photo" width="100%"/>
...
<img src="/static/images/blog-assets/indexing-and-reorgs-1.png" alt="Indexing & Reorgs" width="100%"/>

### Chain

A series of sequential blocks.

<img src="/static/images/blog-assets/indexing-and-reorgs-2.png" alt="Indexing & Reorgs" width="100%"/>

### Miners

Actors that try to submit the next valid block.

<img src="/static/images/blog-assets/indexing-and-reorgs-3.png" alt="Indexing & Reorgs" width="100%"/>

### Chain fork

<img src="/static/images/blog-assets/indexing-and-reorgs-4.png" alt="Indexing & Reorgs" width="100%"/>
...
<img src="/static/images/blog-assets/indexing-and-reorgs-5.png" alt="Indexing & Reorgs" width="100%"/>
