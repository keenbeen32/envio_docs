...
description: "Third monthly community update covering benchmarking results, bounty program updates, and technical developments from the Envio team."
---

<img src="/static/images/blog-assets/envio-developer-community-update-3.png" alt="Cover Image Envio Developer Community Update No.3" width="100%"/>
...
If you don't see anything that tickles your fancy, we also have the Envio "[Build Bigger. Ship faster](/Blog/2023-08-22-envio-grant-program-is-live)" grant program running with a few interesting use cases where you are more than welcome to apply using your own ideas. Feel free to DM the team or drop your suggestions in our Discord and we'll get back to you ASAP Rocky!
...
<img src="/static/images/blog-assets/envio-encode-club-hackathon.jpeg" alt="Encode Club Hackathon Bounty Announcement" width="100%"/>
