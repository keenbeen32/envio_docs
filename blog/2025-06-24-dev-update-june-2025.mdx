...
description: "June 2025 developer update covering v2.22.0 → v2.24.0 with new helpers, loader improvements, and Mission 4 wrap-up."
---

<img src="/static/images/blog-assets/dev-update-june-2025.png" alt="Cover Image Envio Developer Community Update June 2025" width="100%"/>
...
Learn more about optimizing database access with loaders in our [docs](/HyperIndex/loaders).
...
Learn more about multi-chain event ordering in our [docs](/HyperIndex/multichain-indexing#multichain-event-ordering).
...
With the latest update, none of these are necessary. Feel free to remove them, and instead of using `ts-node generated/src/Index.bs.js`, simply replace it with `envio start`.
...
<img src="/static/images/blog-assets/visualizers-and-dash-monad.png" alt="mission 4" width="100%"/>
...
Catch the highlights in our [blog](/blog/2025-06-24-building-visualizers-and-dashboards-on-monad).

## Exploring Cross-Chain Arbitrage on Uniswap V4

<img src="/static/images/blog-assets/arbitrage-v4.png" alt="v4 arbitrage" width="100%"/>
...
<img src="/static/images/blog-assets/megaeth.png" alt="index megaeth data" width="100%"/>
...
Learn more about how to efficiently index data on MegaEth in our [blog](/blog/2025-06-17-how-to-index-megaeth-data-using-envio).

## Join Us at Pragma Cannes

<img src="/static/images/blog-assets/pragma-jonjon.png" alt="pragma jonjon" width="100%"/>
...
<img src="/static/images/blog-assets/analyzing-safe-data.png" alt="safe data" width="100%"/>
...
<img src="/static/images/blog-assets/index-data-on-monad.png" alt="indexing monad" width="100%"/>
...
Learn more about how to efficiently index data on Monad in our [blog](/blog/2025-06-12-how-to-index-monad-data-using-envio).
...
<img src="/static/images/blog-assets/dev-of-the-month-june-2025.png" alt="DOTM June" width="100%"/>
...
<img src="/static/images/blog-assets/june-playlist.png" alt="hjune playlist" width="100%"/>
