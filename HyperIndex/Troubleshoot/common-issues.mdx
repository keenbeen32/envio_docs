...
<Warning>
Always run `pnpm codegen` immediately after cloning an indexer repository using Envio.
</Warning>
...
1. **Recommended:** Use [HyperSync](/HyperIndex/Advanced/hypersync) if your network is supported, as it provides better performance and reliability
