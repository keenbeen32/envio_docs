...
- Review the [reserved words list](/HyperIndex/Troubleshoot/reserved-words) for JavaScript, TypeScript, and ReScript
...
- Refer to the [configuration guide](/HyperIndex/Guides/configuration-file) for correct event definition syntax
...
- See the [HyperSync Data Source](/HyperIndex/Advanced/hypersync) or [RPC Data Source](/HyperIndex/Advanced/rpc-sync) documentation
- Example:
...
- Check the [reserved words list](/HyperIndex/Troubleshoot/reserved-words)
...
**Solution**: Use one of the supported methods for entity references as outlined in the [schema documentation](/HyperIndex/Guides/schema-file).

#### `EE212`: Reserved Enum Names

**Issue**: The schema uses enum names that conflict with Envio's internal enums.

**Solution**: Check the [internal reserved types list](/HyperIndex/Troubleshoot/reserved-words#envio-internal-reserved-types) and rename conflicting enums.
...
- Refer to the [event handlers documentation](/HyperIndex/Guides/event-handlers) for proper setup
