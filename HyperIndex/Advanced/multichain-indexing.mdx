...
For a comprehensive, production-ready example of multichain indexing, we recommend exploring our [Uniswap V4 Multichain Indexer](/HyperIndex/Examples/example-uniswap-v4). This official reference implementation:
...
<img src="/static/images/v4.gif" alt="V4 Indexer Demo" width="100%"/>
...
- Operations on your entities are [commutative](/HyperIndex/Advanced/terminology#commutative-property) (order doesn't matter)
...
- Explore our [Uniswap V4 Multichain Indexer](/HyperIndex/Examples/example-uniswap-v4) for a complete implementation
- Review [performance optimization techniques](/HyperIndex/Advanced/performance/database-performance-optimization) for your indexer
