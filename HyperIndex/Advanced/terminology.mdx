...
<CardGroup cols={2}>
  <Card title="Blockchain Fundamentals" href="#blockchain-fundamentals" />
  <Card title="Smart Contract Concepts" href="#smart-contract-concepts" />
  <Card title="Indexing & Data" href="#indexing--data" />
  <Card title="Development Tools" href="#development-tools" />
  <Card title="Programming Languages" href="#programming-languages" />
  <Card title="Envio Platform" href="#envio-platform" />
  <Card title="Mathematical Concepts" href="#mathematical-concepts" />
</CardGroup>
