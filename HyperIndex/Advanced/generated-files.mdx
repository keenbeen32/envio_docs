...
<Warning>
Generated files should never be manually edited. Any changes will be overwritten the next time code generation runs.
</Warning>
...
```rescript icon="/static/icons/rescript-icon.png"
type pool = {
  id: string,
  chainId: BigInt.t,
  currency0: string,
