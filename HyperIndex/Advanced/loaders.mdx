---
title: "Loaders (Deprecated)"
description: "Learn how Loaders improved database access performance for event handlers."
---

<Warning>
Loaders are a predecessor of [Preload Optimization](/HyperIndex/Advanced/preload-optimization). We recommend using [Preload Optimization](/HyperIndex/Advanced/preload-optimization) instead of loaders. This guide is kept for historical purposes.
</Warning>
...
They worked by implementing the [Preload Optimization](/HyperIndex/Advanced/preload-optimization) - loading required data upfront before processing events.
...
Compared to the current [Preload Optimization](/HyperIndex/Advanced/preload-optimization) approach, handlers with loaders didn't have the Preload Phase, and always ran once.
...
Find more information about how Loaders work by reading the [Preload Optimization - How It Works?](/HyperIndex/Advanced/preload-optimization#how-it-works) guide. Loaders share the same concept, but with a different API.
