...
![Basic NFT ownership data](/images/docs-assets/ipfs-screenshot.jpg)
...
```typescript icon="/icons/typescript-icon.png" title="utils/ipfs.ts"
...
![NFT ownership and metadata](/images/docs-assets/ipfs-screenshot-2.jpg)
