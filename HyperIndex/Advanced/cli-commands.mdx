...
<CardGroup cols={2}>
  <Card title="Initialization Commands" icon="rocket" href="#initialization-commands">
    Create new indexer projects
  </Card>
  
  <Card title="Development Commands" icon="code" href="#development-commands">
    Run, develop, and test indexers
  </Card>
  
  <Card title="Environment Management" icon="server" href="#environment-management-commands">
    Manage local environment and Docker
  </Card>
  
  <Card title="Analysis Tools" icon="chart-line" href="#analysis-tools">
