---
title: DOS Chain
description: Index DOS Chain data using Envio HyperIndex via RPC
---
...
To use DOS Chain, define the RPC configuration in your network configuration file as follows:
