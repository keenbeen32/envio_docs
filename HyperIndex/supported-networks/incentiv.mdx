---
title: Incentiv
description: Index Incentiv data using Envio HyperIndex
---
...
HyperSync accelerates the synchronization of historical data on Incentiv, enabling what usually takes hours to sync millions of events to be completed in under a minute—up to 2000x faster than traditional RPC methods.
