...
```typescript icon="/icons/typescript-icon.png" TypeScript
...
```javascript icon="/icons/javascript-icon.png" JavaScript
...
```rescript icon="/icons/rescript-icon.png" ReScript
