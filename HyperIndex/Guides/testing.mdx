...
```typescript icon="/icons/typescript-icon.png" title="test.ts"
...
```javascript icon="/icons/javascript-icon.png" title="test.js"
it("A NewGreeting event creates a User entity", async () => {
  // Step 1: Initialize an empty mock database
  const mockDb = MockDb.createMockDb();
...
```rescript icon="/icons/rescript-icon.png" title="test.res"
it("A NewGreeting event creates a User entity", async () => {
    // Step 1: Initialize an empty mock database
