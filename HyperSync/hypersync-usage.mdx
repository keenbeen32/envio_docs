...
<CardGroup cols={2}>
  <Card title="Queries" icon="magnifying-glass">
    Define what blockchain data you want to retrieve
  </Card>
  <Card title="Output Configuration" icon="gear">
    Specify how you want that data formatted and delivered
  </Card>
</CardGroup>
...
```python icon="/static/icons/python-icon.png"
...
<CardGroup cols={2}>
  <Card title="Type Safety" icon="shield-check">
    Values are properly converted to their corresponding types
  </Card>
  <Card title="Simplified Access" icon="hand-point-up">
    Direct access to named parameters
  </Card>
  <Card title="Batch Processing" icon="layer-group">
    Decode multiple logs with a single call
  </Card>
  <Card title="Multiple Event Support" icon="list">
    Handle different event types in the same processing pipeline
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Client Libraries" href="/HyperSync/hypersync-clients" icon="code">
    Browse Python, Rust, Node.js, and Go clients
  </Card>
  <Card title="Advanced Query Options" href="/HyperSync/hypersync-query" icon="book">
    Learn about advanced query capabilities
  </Card>
  <Card title="Common Use Cases" href="/HyperSync/hypersync-curl-examples" icon="terminal">
    See example queries
  </Card>
  <Card title="Get API Token" href="/HyperSync/api-tokens" icon="key">
    Start building with your API token
  </Card>
</CardGroup>
