...
description: Explore all fields and parameters for HyperFuel queries.
---
...
<CardGroup cols={2}>
<Card title="Top-level Query Structure" icon="diagram-project" href="#top-level-query-structure">
Core query parameters and configuration
</Card>
<Card title="Receipt Selection" icon="receipt" href="#receiptselection">
Filtering and selecting receipts
</Card>
<Card title="Input Selection" icon="arrow-right-to-bracket" href="#inputselection">
Filtering and selecting inputs
</Card>
<Card title="Output Selection" icon="arrow-right-from-bracket" href="#outputselection">
Filtering and selecting outputs
</Card>
<Card title="Field Selection" icon="list-check" href="#fieldselection">
...
```json icon="/static/icons/json-icon.svg" title="Query Structure"
{
...
The query takes an array of ReceiptSelection objects and returns receipts that match any of the selections. All fields are optional. Below is an exhaustive list of all fields in a ReceiptSelection JSON object. Reference the [Fuel docs on receipts](https://docs.fuel.network/docs/specs/abi/receipts/#receipts) for field explanations.

```json icon="/static/icons/json-icon.svg" title="ReceiptSelection"
{
...
The query takes an array of InputSelection objects and returns inputs that match any of the selections. All fields are optional. Below is an exhaustive list of all fields in an InputSelection JSON object. Reference the [Fuel docs on inputs](https://docs.fuel.network/docs/specs/tx-format/input/#input) for field explanations.

```json icon="/static/icons/json-icon.svg" title="InputSelection"
{
...
The query takes an array of OutputSelection objects and returns outputs that match any of the selections. All fields are optional. Below is an exhaustive list of all fields in an OutputSelection JSON object. Reference the [Fuel docs on outputs](https://docs.fuel.network/docs/specs/tx-format/output/#output) for field explanations.

```json icon="/static/icons/json-icon.svg" title="OutputSelection"
{
