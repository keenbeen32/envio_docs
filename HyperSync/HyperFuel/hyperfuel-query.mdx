...
```json icon="/icons/json-icon.svg" title="Query Structure"
{
...
```json icon="/icons/json-icon.svg" title="ReceiptSelection"
{
...
```json icon="/icons/json-icon.svg" title="InputSelection"
{
...
```json icon="/icons/json-icon.svg" title="OutputSelection"
{
...
```json icon="/icons/json-icon.svg" title="FieldSelection"
{
    "block": [
        "id",
        "da_height",
