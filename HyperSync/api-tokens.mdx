...
<CodeGroup>
```typescript icon="/static/icons/typescript-icon.png" title="TypeScript/JavaScript"
...
```python icon="/static/icons/python-icon.png" title="Python"
...
```rust icon="/static/icons/rust-icon.png" title="Rust"
