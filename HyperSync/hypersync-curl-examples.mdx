...
<CardGroup cols={2}>
<Card title="Curl vs. Client Libraries" icon="code-compare" href="#curl-vs-client-libraries">
Choose the right tool for your use case
</Card>
<Card title="ERC-20 Transfers" icon="arrow-right-arrow-left" href="#get-all-erc-20-transfers-for-an-address">
Get all token transfers for an address
</Card>
<Card title="Contract Event Logs" icon="file-lines" href="#get-all-logs-for-a-smart-contract">
Retrieve all logs for a smart contract
</Card>
<Card title="Blob Transactions" icon="database" href="#get-blob-data-for-the-optimism-chain">
Find blob data for L2 chains
</Card>
<Card title="Token Mint Events" icon="plus-circle" href="#get-mint-usdc-events">
Track token minting events
</Card>
<Card title="Address Transactions" icon="address-card" href="#get-all-transactions-for-an-address">
Get all transactions for an address
</Card>
<Card title="Transaction Status" icon="circle-check" href="#get-successful-or-failed-transactions">
Filter by successful or failed status
</Card>
</CardGroup>
