...
For more details on client libraries, see the [HyperSync Clients](/HyperSync/hypersync-clients) documentation.
...
<CardGroup cols={2}>
<Card title="Understanding HyperSync Queries" icon="lightbulb" href="#understanding-hypersync-queries">
Learn the basics of HyperSync query structure
</Card>
<Card title="Query Execution Process" icon="gear" href="#query-execution-process">
How queries are processed and paginated
</Card>
<Card title="Query Structure Reference" icon="code" href="#query-structure-reference">
Complete reference for query parameters
</Card>
<Card title="Data Schema" icon="table" href="#data-schema">
Available fields for blocks, transactions, logs, and traces
</Card>
<Card title="Response Structure" icon="reply" href="#response-structure">
Understanding query response format
</Card>
<Card title="Stream and Collect Functions" icon="stream" href="#stream-and-collect-functions">
Using advanced data processing functions
</Card>
<Card title="Working with Join Modes" icon="link" href="#working-with-join-modes">
How to connect related blockchain data
</Card>
...
| **max_num_\*** | User-specified maximum number of results by type | May slightly exceed limit to complete current block group |
</Card>
</div>
...
```javascript icon="/static/icons/javascript-icon.png" title="reverse-search.js"
...
```rust icon="/static/icons/rust-icon.png" title="Query Structure"
struct Query {
...
```rust icon="/static/icons/rust-icon.png" title="LogSelection"
struct LogSelection {
...
```rust icon="/static/icons/rust-icon.png" title="TransactionSelection"
...
```rust icon="/static/icons/rust-icon.png" title="BlockSelection"
...
```rust icon="/static/icons/rust-icon.png" title="TraceSelection"
...
```rust icon="/static/icons/rust-icon.png" title="FieldSelection"
...
```python icon="/static/icons/python-icon.png" title="Block Fields"
...
```python icon="/static/icons/python-icon.png" title="Transaction Fields"
...
```python icon="/static/icons/python-icon.png" title="Log Fields"
...
```python icon="/static/icons/python-icon.png" title="Trace Fields"
...
```rust icon="/static/icons/rust-icon.png" title="QueryResponse"
...
```rust icon="/static/icons/rust-icon.png" title="RollbackGuard"
