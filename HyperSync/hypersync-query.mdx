...
```javascript icon="/icons/javascript-icon.png" title="reverse-search.js"
...
```rust icon="/icons/rust-icon.png" title="Query Structure"
struct Query {
...
```rust icon="/icons/rust-icon.png" title="LogSelection"
struct LogSelection {
...
```rust icon="/icons/rust-icon.png" title="TransactionSelection"
...
```rust icon="/icons/rust-icon.png" title="BlockSelection"
...
```rust icon="/icons/rust-icon.png" title="TraceSelection"
...
```rust icon="/icons/rust-icon.png" title="FieldSelection"
...
```python icon="/icons/python-icon.png" title="Block Fields"
...
```python icon="/icons/python-icon.png" title="Transaction Fields"
...
```python icon="/icons/python-icon.png" title="Log Fields"
...
```python icon="/icons/python-icon.png" title="Trace Fields"
...
```rust icon="/icons/rust-icon.png" title="QueryResponse"
...
```rust icon="/icons/rust-icon.png" title="RollbackGuard"
